    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, upload_to='courses/%Y/%m', verbose_name='封面图')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('youneed_know', models.TextField(verbose_name='课程须知')),
                ('teacher_tell', models.TextField(verbose_name='老师告诉你')),
        ...
        migrations.AddField(
            model_name='course',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.Teacher', verbose_name='任课教师'),
        ),
        migrations.CreateModel(
            name='BannerCourse',
            fields=[
